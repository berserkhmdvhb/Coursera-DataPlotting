...
0})(function(h){function k(y,w,B){return"DATA_LAYER"===y?lm(B):h[w]}function l(){u("gdpr_consent",gj());}function n(){}function q(y){var w=!0;y&&n();w&&b.push(r)}mh();var r={google_basket_transaction_type:"purchase",google_conversion_domain:"",google_conversion_id:h.vtp_conversionId,google_conversion_label:h.vtp_conversionLabel,
google_conversion_value:h.vtp_conversionValue||0,google_remarketing_only:!1,onload_callback:h.vtp_gtmOnSuccess,gtm_onFailure:h.vtp_gtmOnFailure,google_gtm:Ei()};h.vtp_rdp&&(r.google_restricted_data_processing=!0);void 0!=lm(C.M)&&!1!==lm(C.M)&&(r.google_gtm_url_processor=function(y){return y=Lg(y)});var t=function(y){return function(w,B,z){var A=k(y,B,z);A&&(r[w]=A)}},
p=t("JSON");p("google_conversion_currency","vtp_currencyCode");p("google_conversion_order_id","vtp_orderId");h.vtp_enableProductReporting&&(p=t(h.vtp_productReportingDataSource),p("google_conversion_merchant_id","vtp_awMerchantId","aw_merchant_id"),p("google_basket_feed_country","vtp_awFeedCountry","aw_feed_country"),p("google_basket_feed_language","vtp_awFeedLanguage","aw_feed_language"),p("google_basket_discount","vtp_discount","discount"),p("google_conversion_items","vtp_items","items"),r.google_conversion_items&&
r.google_conversion_items.map&&(r.google_conversion_items=r.google_conversion_items.map(function(y){return{value:y.price,quantity:y.quantity,item_id:y.id}})));var u=function(y,w){void 0!==w&&((r.google_additional_conversion_params=r.google_additional_conversion_params||{})[y]=w)},v=function(y){return function(w,B,z,A){var E=k(y,B,z);A(E)&&u(w,E)}};(function(){})();h.vtp_transportUrl&&(r.google_transport_url=h.vtp_transportUrl);var x=qi(h.vtp_transportUrl,"/pagead/conversion_async.js");x||(x=-1==navigator.userAgent.toLowerCase().indexOf("firefox")?"//www.googleadservices.com/pagead/conversion_async.js":"https://www.google.com/pagead/conversion_async.js");
h.vtp_enableNewCustomerReporting&&(p=v(h.vtp_newCustomerReportingDataSource),p("vdnc","vtp_awNewCustomer","new_customer",function(y){return void 0!=y&&""!==y}),p("vdltv","vtp_awCustomerLTV","customer_lifetime_value",function(y){return void 0!=y&&""!==y}));!h.hasOwnProperty("vtp_enableConversionLinker")||h.vtp_enableConversionLinker?(h.vtp_conversionCookiePrefix&&(r.google_gcl_cookie_prefix=h.vtp_conversionCookiePrefix),r.google_read_gcl_cookie_opt_out=!1):r.google_read_gcl_cookie_opt_out=!0;"1"===
Gf(!1)._up&&u("gtm_up","1");l();(function(){td()?Gd(function(){l();var y=Ad(C.s),w=!y&&void 0!=lm(C.M)&&!1!==lm(C.M);!h.vtp_transportUrl&&w&&(r.google_transport_url="https://pagead2.googlesyndication.com/");u("gcs",Fd());q(y);y||wd(function(){l();r=m(r);!h.vtp_transportUrl&&r.google_transport_url&&delete r.google_transport_url;u("gcs",Fd());u("gcu","1");q(!0)},C.s)},[C.s]):q(!0)})();a||(a=!0,N(x,f(),e(x)))})}();




Z.a.hid=["google"],function(){(function(a){Z.__hid=a;Z.__hid.b="hid";Z.__hid.g=!0;Z.__hid.priorityOverride=0})(function(){return Fl.Ub})}();
